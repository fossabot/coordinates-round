...
describe('round-ccord.js to round coordinates to given decimal digits', () => {
  ...
  it('Test when type is NOT LineString NOR MultiLineString.', () => {
    const input = feature;
    input.geometry.type = "MultiLineString";
    input.geometry.coordinates = [];
    const expected = [];
  ...
  it('Test when coordinates are Polygon and rounded to 5 decimal digits.', () => {
    ...
    input.geometry.coordinates = [[[-0.1, 51], [-0.134909857, 51.52460983], [-0.15, 52], [-0.1, 51]]];
  ...
  it('Test when coordinates are MultiPoint and rounded with some to upper and lower bound.', () => {
    const input = feature;
    input.geometry.type = "MultiPoint";
    input.geometry.coordinates = [[-0.13, 51.52], [-0.13596983326, 51.52333342]];
